...
/* Punchier, 4‑stop animated gradient */
background: radial-gradient(
80vmax 80vmax at 15% 85%,
...
<!-- Logo from original Reading Room -->
...
<!-- Floating timer settings (hidden) -->
